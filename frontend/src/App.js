...
function App() {
  ...
  const api = `http://20.244.56.144/test/companies/${retailerMap[options[selected]]}/categories/${options2[selected2]}/products?top=10&minPrice=${minPrice}&maxPrice=${maxPrice}`;
  try{
